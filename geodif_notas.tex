...
\begin{adjustbox}{max width=\textwidth}
  \begin{tikzcd}[column sep = 10pt]
H^1(M,\Z/2\Z) \rar & \check{H}^1(M,\left\{U_i,i\in I\right\}, \mathrm{Spin}_n(\RR)) \rar & \check{H}^1(M,\left\{U_i,i\in I\right\},\SO_n(\RR)) \rar & H^2(M,\Z/2\Z),
  \end{tikzcd}
\end{adjustbox}
\end{center}
...
\todo{Grupo de holonomía y teorema de Berger}
