...
\subsubsection{} Dos estructuras diferenciables en $\RR$. Lo que pasa en $\RR^4$.

\subsubsection{} Recta con dos orígenes.

\subsubsection{} Unión no numerable de $\RR^n$s.


\section{El espacio tangente}
a

Añadir: valor regular, función implícita, etc. Esferas con norma = 1, SLn.
