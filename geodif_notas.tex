...
\begin{prop}
Sea $I^\bullet$ es un complejo de cocadenas inyectivo acotado. Si $I^\bullet$ es cuasi-isomorfo a $0$, entonces es contractible.
...
Falta ver que, en efecto, las resoluciones son funtoriales.

%\begin{prop}
%  Sea $f:A\rightarrow B$ un morfismo en una categoría abeliana $\sfA$. Si $A\rightarrow I^\bullet_A$ y $B\rightarrow I^\bullet_B$ son resoluciones inyectivas, entonces existe un único (salvo homotopía) morfismo de complejos $f^\bullet:I^\bullet_A\rightarrow I^\bullet_B$ tal que el siguiente diagrama conmuta
%  \begin{center}
%    \begin{tikzcd}
...
%    \end{tikzcd}
%  \end{center}
%Dualmente, si $P_A^\bullet\rightarrow A$ y $P^\bullet_B\rightarrow B$ son resoluciones proyectivas, entonces existe un único (salvo homotopía) morfismo de complejos $f^\bullet:P^\bullet_A\rightarrow P^\bullet_B$ tal que el siguiente diagrama conmuta
%  \begin{center}
%    \begin{tikzcd}
%     P^\bullet_A \ar{r} \ar{d}{f^\bullet} & A \ar{d}{f} \\
%     P^\bullet_B \ar{r} & B.
%    \end{tikzcd}
%  \end{center}
%\end{prop}
